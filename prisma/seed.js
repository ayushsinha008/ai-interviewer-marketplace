...
const feedback = {
  summary:
    "The candidate demonstrated a solid understanding of React fundamentals and component architecture. They approached problems methodically and showed good instincts around state management. With some refinement in system design and async patterns, they're well on track for a mid-level frontend role.",
  technical:
  ...
  sessionRating: 4,
  sessionComment:
    "Great session — the candidate was engaged and receptive to feedback. Would be happy to interview them again after more system design prep.",
};
